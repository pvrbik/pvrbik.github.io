...
\begin{figure}[h]
\begin{center}
\scalebox{0.5}{\includegraphics{figures/lj}}
...
presentation similar to (and beter than) PowerPoint. Conversion to HTML is
